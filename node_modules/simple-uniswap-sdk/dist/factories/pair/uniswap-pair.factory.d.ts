...
export declare class UniswapPairFactory {
    ...
    constructor(_uniswapPairFactoryContext: UniswapPairFactoryContext);
    /**
     * The to token
     */
    get toToken(): Token;
     ...
     */
    hasGotEnoughAllowance(uniswapVersion: UniswapVersion, amount: string): Promise<boolean>;
    /**
     * Has got enough allowance to do the trade
     * @param amount The amount you want to swap
     */
     ...
     * @param uniswapVersion The uniswap version
     */
    getAllowanceAndBalanceOfForFromToken(uniswapVersion: UniswapVersion): Promise<AllowanceAndBalanceOf>;
    /**
     * Get the allowance and balance for to from token (eth > erc20) only
     * @param uniswapVersion The uniswap version
     */
    getAllowanceAndBalanceOfForToToken(uniswapVersion: UniswapVersion): Promise<AllowanceAndBalanceOf>;
    /**
