...
class UniswapRouterContractFactoryV2 {
    constructor(_ethersProvider) {
        this._ethersProvider = _ethersProvider;
        this._uniswapRouterContract = this._ethersProvider.getContract(JSON.stringify(uniswap_contract_context_v2_1.UniswapContractContextV2.routerAbi), uniswap_contract_context_v2_1.UniswapContractContextV2.routerAddress);
    }
    ...
    factory() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._uniswapRouterContract.factory();
        });
    }
    getAmountsOut(amountIn, path) {
        return __awaiter(this, void 0, void 0, function* () {
            const amounts = yield this._uniswapRouterContract.getAmountsOut(amountIn, path);
            return amounts.map((c) => c.toHexString());
        });
    }
    quote(amountA, reserveA, reserveB) {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield this._uniswapRouterContract.quote(amountA, reserveA, reserveB)).toHexString();
        });
    }
